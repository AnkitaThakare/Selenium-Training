...
public class Handling_WebTable_Pagination_Example
{
	...
	public void Add_Employee() throws InterruptedException {
		driver.findElements("btnAdd").click();
		...
		driver.findElements("systemUser_userName").sendKeys("Dixit" + randomInt);
		//String ExpUserName=driver.findElementById("systemUser_userName").getText();
		driver.findElements("systemUser_password").sendKeys("admin123");
		driver.findElements("systemUser_confirmPassword").sendKeys("admin123");
		Thread.sleep(5000);
		driver.findElements("btnSave").click();
